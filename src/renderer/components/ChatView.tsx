...
export function ChatView() {
  ...
  useEffect(() => {
    ...
    updateScrollState();
    // When the user is reading older messages, prevent new messages from auto-scrolling and disrupting their view
  ...
  }, [scrollToBottom]); // ResizeObserver callback uses refs for scroll state
